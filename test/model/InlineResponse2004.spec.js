...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MsbPayApi.InlineResponse2004();
  });
  ...
  describe('InlineResponse2004', function() {
    it('should create an instance of InlineResponse2004', function() {
      ...
      //var instane = new MsbPayApi.InlineResponse2004();
      //expect(instance).to.be.a(MsbPayApi.InlineResponse2004);
    });

    it('should have the property resultCodes (base name: "resultCodes")', function() {
      // uncomment below and update the code to test the property resultCodes
      //var instane = new MsbPayApi.InlineResponse2004();
