...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MsbPayApi.InlineResponse2005();
  });
  ...
  describe('InlineResponse2005', function() {
    it('should create an instance of InlineResponse2005', function() {
      ...
      //var instane = new MsbPayApi.InlineResponse2005();
      //expect(instance).to.be.a(MsbPayApi.InlineResponse2005);
    });

    it('should have the property cartOrders (base name: "cartOrders")', function() {
      // uncomment below and update the code to test the property cartOrders
      //var instane = new MsbPayApi.InlineResponse2005();
