...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MsbPayApi.CartOrderItem();
  });
  ...
  describe('CartOrderItem', function() {
    it('should create an instance of CartOrderItem', function() {
      // uncomment below and update the code to test CartOrderItem
      //var instane = new MsbPayApi.CartOrderItem();
      //expect(instance).to.be.a(MsbPayApi.CartOrderItem);
    });
