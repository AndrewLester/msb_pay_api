...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MsbPayApi.InlineResponse2003();
  });
  ...
  describe('InlineResponse2003', function() {
    it('should create an instance of InlineResponse2003', function() {
      ...
      //var instane = new MsbPayApi.InlineResponse2003();
      //expect(instance).to.be.a(MsbPayApi.InlineResponse2003);
    });

    it('should have the property responseBoolean (base name: "responseBoolean")', function() {
      // uncomment below and update the code to test the property responseBoolean
      //var instane = new MsbPayApi.InlineResponse2003();
