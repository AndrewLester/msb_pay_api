...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MsbPayApi.InlineResponse20011();
  });
  ...
  describe('InlineResponse20011', function() {
    it('should create an instance of InlineResponse20011', function() {
      ...
      //var instane = new MsbPayApi.InlineResponse20011();
      //expect(instance).to.be.a(MsbPayApi.InlineResponse20011);
    });

    it('should have the property glaccounts (base name: "glaccounts")', function() {
      // uncomment below and update the code to test the property glaccounts
      //var instane = new MsbPayApi.InlineResponse20011();
