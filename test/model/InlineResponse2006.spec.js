...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MsbPayApi.InlineResponse2006();
  });
  ...
  describe('InlineResponse2006', function() {
    it('should create an instance of InlineResponse2006', function() {
      ...
      //var instane = new MsbPayApi.InlineResponse2006();
      //expect(instance).to.be.a(MsbPayApi.InlineResponse2006);
    });

    it('should have the property cartPayments (base name: "cartPayments")', function() {
      // uncomment below and update the code to test the property cartPayments
      //var instane = new MsbPayApi.InlineResponse2006();
