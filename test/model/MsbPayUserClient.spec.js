...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MsbPayApi.MsbPayUserClient();
  });
  ...
  describe('MsbPayUserClient', function() {
    it('should create an instance of MsbPayUserClient', function() {
      // uncomment below and update the code to test MsbPayUserClient
      //var instane = new MsbPayApi.MsbPayUserClient();
      //expect(instance).to.be.a(MsbPayApi.MsbPayUserClient);
    });
